...
public interface PropertyRepository extends MongoRepository<Property, String> {
    ...
    List<Property> findByCityIgnoreCaseAndPropertyTypeIgnoreCase(String city, String propertyType);

    List<Property> findByCityIgnoreCaseAndPriceBetween(String city, Double minPrice, Double maxPrice);
