...
public class PropertyManagementController {
    ...
    public ResponseEntity<ApiResponse<PropertyResponseDTO>> registerProperty(@Valid @RequestBody PropertyRequestDTO request) {
        return ResponseEntity.status(HttpStatus.CREATED).body(new ApiResponse<>(ApiStatus.SUCCESS, "Property registered successfully", propertyService.registerProperty(request)));
    }
    ...
    public ResponseEntity<ApiResponse<PropertyResponseDTO>> updateProperty(@PathVariable String propertyId, @Valid @RequestBody PropertyPatchRequestDTO request) {
