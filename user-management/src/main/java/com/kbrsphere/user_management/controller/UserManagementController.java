...
public class UserManagementController {
    ...
    public ResponseEntity<ApiResponse<UserResponseDTO>> register(@Valid @RequestBody UserRequestDTO request) {
        return ResponseEntity.status(201).body(new ApiResponse<>(ApiStatus.SUCCESS, "User registered successfully", service.register(request)));
    }
    ...
    public ResponseEntity<ApiResponse<List<UserResponseDTO>>> getUsers() {
        return ResponseEntity.ok(new ApiResponse<>(ApiStatus.SUCCESS, "Users fetched successfully", service.getUsers()));
    }
    ...
    public ResponseEntity<ApiResponse<UserResponseDTO>> getUser(@PathVariable String id) {
        return ResponseEntity.ok(new ApiResponse<>(ApiStatus.SUCCESS, "User fetched successfully", service.getUserById(id)));
    }
    ...
    public ResponseEntity<ApiResponse<UserResponseDTO>> updateDetails(@PathVariable String id, @RequestBody UpdateUserDTO request) {
        return ResponseEntity.ok(new ApiResponse<>(ApiStatus.SUCCESS, "Details updated successfully", service.updateUserDetails(id, request)));
    }
    ...
    public ResponseEntity<ApiResponse<String>> updatePassword(@Valid @PathVariable String id, @Valid @RequestBody UpdatePasswordDTO request) {
        ...
        return ResponseEntity.ok(new ApiResponse<>(ApiStatus.SUCCESS, "Password updated successfully", null));
    }
    ...
    public ResponseEntity<ApiResponse<String>> deleteUserAccount(@PathVariable String id) {
        ...
        return ResponseEntity.ok(new ApiResponse<>(ApiStatus.SUCCESS, "Account deleted successfully", null));
    }
    ...
    public ResponseEntity<ApiResponse<List<UserResponseDTO>>> getUsersByRole(@PathVariable String role) {
        return ResponseEntity.ok(new ApiResponse<>(ApiStatus.SUCCESS, "Users fetched successfully", service.getUsersByRole(role)));
    }
}